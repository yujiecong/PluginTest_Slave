...
public:
	...
	static UE_API bool RecompileBlueprintStageActor(AMyUsdStageActor* BlueprintDerivedStageActor);
	...
	UE_DEPRECATED(5.4, "These functions were meant for internal testing only and will be removed in a future release.")
	UFUNCTION(BlueprintCallable, Category = "Blueprint")
	static UE_API void DirtyStageActorBlueprint(AMyUsdStageActor* BlueprintDerivedStageActor);
	...
	static UE_API int64 GetSubtreeVertexCount(AMyUsdStageActor* StageActor, const FString& PrimPath);
	...
	UE_DEPRECATED(5.4, "These functions were meant for internal testing only and will be removed in a future release.")
	UFUNCTION(BlueprintCallable, Category = "Counts")
	static UE_API int64 GetSubtreeMaterialSlotCount(AMyUsdStageActor* StageActor, const FString& PrimPath);
	...
	UE_DEPRECATED(5.4, "These functions were meant for internal testing only and will be removed in a future release.")
	UFUNCTION(BlueprintCallable, Category = "Counts")
	static UE_API void SetUsdStageCpp(AMyUsdStageActor* StageActor, const FString& NewStageRootLayer);
