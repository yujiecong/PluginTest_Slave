...
class UMyUsdStageEditorBlueprintLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static UE_API bool OpenStageEditor();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Stage Editor")
	static UE_API bool CloseStageEditor();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Stage Editor")
	static UE_API bool IsStageEditorOpened();
	...
	static UE_API AMyUsdStageActor* GetAttachedStageActor();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Stage Actor")
	static UE_API bool SetAttachedStageActor(AMyUsdStageActor* NewActor);
	...
	static UE_API TArray<FString> GetSelectedLayerIdentifiers();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API void SetSelectedLayerIdentifiers(const TArray<FString>& NewSelection);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API TArray<FString> GetSelectedPrimPaths();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API void SetSelectedPrimPaths(const TArray<FString>& NewSelection);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API TArray<FString> GetSelectedPropertyNames();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API void SetSelectedPropertyNames(const TArray<FString>& NewSelection);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API TArray<FString> GetSelectedPropertyMetadataNames();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Selection")
	static UE_API void SetSelectedPropertyMetadataNames(const TArray<FString>& NewSelection);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void FileOpen(const FString& FilePath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void FileSave(const FString& OutputFilePathIfUnsaved);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void FileExportAllLayers(const FString& OutputDirectory);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void FileExportFlattenedStage(const FString& OutputLayer);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void FileExportFlattenedLayerStack(const FString& OutputLayer);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void ActionsImport(const FString& OutputContentFolder, UMyUsdStageImportOptions* Options);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void ExportSelectedLayers(const FString& OutputDirectory);
};
