...
#define IMAGE_PLUGIN_BRUSH(RelativePath, ...) FSlateImageBrush(FMyUsdStageEditorStyle::InContent(RelativePath, ".png"), __VA_ARGS__)
#define RootToContentDir StyleSet->RootToContentDir

FString FMyUsdStageEditorStyle::InContent(const FString& RelativePath, const ANSICHAR* Extension)
{
	static FString ContentDir = IPluginManager::Get().FindPlugin(TEXT("MyUSDImporter"))->GetContentDir();
	return (ContentDir / RelativePath) + Extension;
}

TSharedPtr<FSlateStyleSet> FMyUsdStageEditorStyle::StyleSet = nullptr;
TSharedPtr<class ISlateStyle> FMyUsdStageEditorStyle::Get()
{
	return StyleSet;
}

FName FMyUsdStageEditorStyle::GetStyleSetName()
{
...
void FMyUsdStageEditorStyle::Initialize()
{
	// Const icon sizes
...
void FMyUsdStageEditorStyle::Shutdown()
{
	if (StyleSet.IsValid())
	{
