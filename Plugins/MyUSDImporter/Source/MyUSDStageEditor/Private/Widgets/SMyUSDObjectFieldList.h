...
class SMyUsdObjectFieldList : public SListView<TSharedPtr<FMyUsdObjectFieldViewModel>>
{
public:
	SLATE_BEGIN_ARGS(SMyUsdObjectFieldList)
	{
	}
...
private:
	FMyUsdObjectFieldsViewModel ViewModel;
