...
class UMyUsdDynamicBindingResolverLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 * @param StageActorIDNameFilter - The "ID Name"/FName of a AMyUsdStageActor to restrict our search for actor and components to. Can be
	 * empty.
	...
	static UE_API FMovieSceneDynamicBindingResolveResult ResolveWithStageActor(
