...
#define UE_API USDSTAGEEDITOR_API
...
public:
	...
	static UE_API AUsdStageActor* GetAttachedStageActor();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Stage Actor")
	static UE_API bool SetAttachedStageActor(AUsdStageActor* NewActor);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "USD|Menu Actions")
	static UE_API void ActionsImport(const FString& OutputContentFolder, UUsdStageImportOptions* Options);
