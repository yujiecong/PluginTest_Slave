...
FMyUsdPrimViewModel::FMyUsdPrimViewModel(FMyUsdPrimViewModel* InParentItem, const UE::FUsdStageWeak& InUsdStage, const UE::FUsdPrim& InPrim)
	...
	, RowData(MakeShared<FMyUsdPrimModel>())
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FMyUsdPrimViewModel::FMyUsdPrimViewModel);
	RefreshData(false);
...
void FMyUsdPrimViewModel::SetIsExpanded(bool bNewIsExpanded)
{
...
bool FMyUsdPrimViewModel::ShouldGenerateChildren() const
{
...
void FMyUsdPrimViewModel::FillChildren()
{
#if USE_USD_SDK
	if (!UsdPrim)
	{
...
void FMyUsdPrimViewModel::RefreshData(bool bRefreshChildren)
{
#if USE_USD_SDK
	...
	{
		FMyUsdPrimViewModel* Item = ParentItem;
		while (Item)
		{
...
bool FMyUsdPrimViewModel::HasVisibilityAttribute() const
{
#if USE_USD_SDK
	if (pxr::UsdGeomImageable UsdGeomImageable = pxr::UsdGeomImageable(UsdPrim))
	{
...
void FMyUsdPrimViewModel::ToggleVisibility()
{
#if USE_USD_SDK
	FScopedUsdAllocs UsdAllocs;
...
void FMyUsdPrimViewModel::TogglePayload()
{
...
void FMyUsdPrimViewModel::ApplySchema(FName SchemaName)
{
#if USE_USD_SDK
...
bool FMyUsdPrimViewModel::CanApplySchema(FName SchemaName) const
{
#if USE_USD_SDK
...
void FMyUsdPrimViewModel::RemoveSchema(FName SchemaName)
{
#if USE_USD_SDK
...
bool FMyUsdPrimViewModel::CanRemoveSchema(FName SchemaName) const
{
#if USE_USD_SDK
...
bool FMyUsdPrimViewModel::HasSpecsOnLocalLayer() const
{
#if USE_USD_SDK
	FScopedUsdAllocs UsdAllocs;
...
bool FMyUsdPrimViewModel::HasReferencesOnLocalLayer() const
{
#if USE_USD_SDK
	FScopedUsdAllocs UsdAllocs;
...
bool FMyUsdPrimViewModel::HasPayloadsOnLocalLayer() const
{
#if USE_USD_SDK
	FScopedUsdAllocs UsdAllocs;
...
void FMyUsdPrimViewModel::DefinePrim(const TCHAR* PrimName)
{
#if USE_USD_SDK
	FScopedUsdAllocs UsdAllocs;
...
void FMyUsdPrimViewModel::ClearReferences()
{
#if USE_USD_SDK
	if (!UsdPrim)
	{
...
void FMyUsdPrimViewModel::ClearPayloads()
{
#if USE_USD_SDK
	if (!UsdPrim)
	{
