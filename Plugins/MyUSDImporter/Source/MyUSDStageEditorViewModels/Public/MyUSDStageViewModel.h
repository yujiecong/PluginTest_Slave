...
public:
	...
	UE_API void ImportStage(const TCHAR* TargetContentFolder = nullptr, UMyUsdStageImportOptions* Options = nullptr);

public:
	TWeakObjectPtr<AMyUsdStageActor> UsdStageActor;
};
