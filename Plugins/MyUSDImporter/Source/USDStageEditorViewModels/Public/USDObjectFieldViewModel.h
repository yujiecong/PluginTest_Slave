...
class FUsdObjectFieldViewModel : public TSharedFromThis<FUsdObjectFieldViewModel>
{
public:
	UE_API explicit FUsdObjectFieldViewModel(FUsdObjectFieldsViewModel* InOwner);
