...
void FMyUsdVolVolumeTranslator::CreateAssets()
{
#if WITH_EDITOR
	TRACE_CPUPROFILER_EVENT_SCOPE(FMyUsdVolVolumeTranslator::CreateAssets);
...
USceneComponent* FMyUsdVolVolumeTranslator::CreateComponents()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FMyUsdVolVolumeTranslator::CreateComponents);
...
void FMyUsdVolVolumeTranslator::UpdateComponents(USceneComponent* SceneComponent)
{
#if WITH_EDITOR
...
bool FMyUsdVolVolumeTranslator::CollapsesChildren(ECollapsingType CollapsingType) const
{
...
bool FMyUsdVolVolumeTranslator::CanBeCollapsed(ECollapsingType CollapsingType) const
{
	return false;
}

TSet<UE::FSdfPath> FMyUsdVolVolumeTranslator::CollectAuxiliaryPrims() const
{
