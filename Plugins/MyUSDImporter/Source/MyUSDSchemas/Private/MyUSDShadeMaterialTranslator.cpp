...
void FMyUsdShadeMaterialTranslator::CreateAssets()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FMyUsdShadeMaterialTranslator::CreateAssets);
...
bool FMyUsdShadeMaterialTranslator::CollapsesChildren(ECollapsingType CollapsingType) const
{
	return false;
}

bool FMyUsdShadeMaterialTranslator::CanBeCollapsed(ECollapsingType CollapsingType) const
{
	return false;
}

void FMyUsdShadeMaterialTranslator::PostImportMaterial(const FString& PrefixedMaterialHash, UMaterialInterface* ImportedMaterial)
{
...
TSet<UE::FSdfPath> FMyUsdShadeMaterialTranslator::CollectAuxiliaryPrims() const
{
