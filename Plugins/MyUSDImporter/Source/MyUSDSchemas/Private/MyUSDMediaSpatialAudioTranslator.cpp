...
void FMyUsdMediaSpatialAudioTranslator::CreateAssets()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FMyUsdMediaSpatialAudioTranslator::CreateAssets);
...
USceneComponent* FMyUsdMediaSpatialAudioTranslator::CreateComponents()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FMyUsdMediaSpatialAudioTranslator::CreateComponents);
...
void FMyUsdMediaSpatialAudioTranslator::UpdateComponents(USceneComponent* SceneComponent)
{
...
bool FMyUsdMediaSpatialAudioTranslator::CollapsesChildren(ECollapsingType CollapsingType) const
{
...
bool FMyUsdMediaSpatialAudioTranslator::CanBeCollapsed(ECollapsingType CollapsingType) const
{
	return false;
}

TSet<UE::FSdfPath> FMyUsdMediaSpatialAudioTranslator::CollectAuxiliaryPrims() const
{
	return {};
}
