...
class FMyUsdNaniteAssemblyCreateAssetsTaskChain : public FBaseBuildStaticMeshTaskChain
{
public:
...
void FMyUsdNaniteAssemblyTranslator::CreateAssets()
{
	using namespace UE::UsdNaniteAssemblyTranslator::Private;
	...
	TSharedPtr<FMyUsdNaniteAssemblyCreateAssetsTaskChain> TaskChain;
	if (RootType == ERootType::SkeletalMesh)
	{
		...
		TaskChain = MakeShared<FMyUsdNaniteAssemblyCreateAssetsTaskChain>(Context, PrimPath, Skeleton, SkelRoot).ToSharedPtr();
	}
	else
	{
		TaskChain = MakeShared<FMyUsdNaniteAssemblyCreateAssetsTaskChain>(Context, PrimPath).ToSharedPtr();
	}
