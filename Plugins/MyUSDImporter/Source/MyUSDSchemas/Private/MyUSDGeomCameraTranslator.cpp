...
void FMyUsdGeomCameraTranslator::UpdateComponents(USceneComponent* SceneComponent)
{
	if (!SceneComponent)
	{
		return;
	...
	FMyUsdGeomXformableTranslator::UpdateComponents(SceneComponent);
...
bool FMyUsdGeomCameraTranslator::CollapsesChildren(ECollapsingType CollapsingType) const
{
...
bool FMyUsdGeomCameraTranslator::CanBeCollapsed(ECollapsingType CollapsingType) const
{
	return false;
}
