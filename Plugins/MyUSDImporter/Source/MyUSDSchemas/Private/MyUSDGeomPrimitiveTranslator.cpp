...
void FMyUsdGeomPrimitiveTranslator::CreateAssets()
{
...
USceneComponent* FMyUsdGeomPrimitiveTranslator::CreateComponents()
{
...
void FMyUsdGeomPrimitiveTranslator::UpdateComponents(USceneComponent* SceneComponent)
{
...
bool FMyUsdGeomPrimitiveTranslator::CollapsesChildren(ECollapsingType CollapsingType) const
{
	...
	// We're going with 'false' here to match FMyUsdGeomMeshTranslator::CollapsesChildren
	return false;
}

bool FMyUsdGeomPrimitiveTranslator::CanBeCollapsed(ECollapsingType CollapsingType) const
{
	return Super::CanBeCollapsed(CollapsingType);
}

TSet<UE::FSdfPath> FMyUsdGeomPrimitiveTranslator::CollectAuxiliaryPrims() const
{
