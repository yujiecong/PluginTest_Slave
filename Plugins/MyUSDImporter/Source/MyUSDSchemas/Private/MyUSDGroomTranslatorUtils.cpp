...
namespace UsdGroomTranslatorUtils
{
	...
	)
	{
		...
		// transaction suppression around the CreateAssets() calls that the AMyUsdStageActor will already do in AMyUsdStageActor::LoadAssets
		// and AMyUsdStageActor::LoadAsset
