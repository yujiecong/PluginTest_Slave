...
class FMyUsdGeomMeshTranslator : public FMyUsdGeomXformableTranslator
{
public:
	...
	FMyUsdGeomMeshTranslator(const FMyUsdGeomMeshTranslator& Other) = delete;
	FMyUsdGeomMeshTranslator& operator=(const FMyUsdGeomMeshTranslator& Other) = delete;
...
protected:
	...
	// where they are, but the fact that we don't have a SkelRootTranslator collapsing anymore means we'll get FMyUsdGeomMeshTranslator
