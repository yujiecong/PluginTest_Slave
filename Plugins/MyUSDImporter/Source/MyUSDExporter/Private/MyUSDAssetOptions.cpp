...
void UsdUtils::AddAnalyticsAttributes(const FMyUsdMeshAssetOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes)
{
...
void UsdUtils::HashForMaterialExport(const FMyUsdMaterialBakingOptions& Options, FSHA1& HashToUpdate)
{
...
void UsdUtils::HashForMeshExport(const FMyUsdMeshAssetOptions& Options, FSHA1& HashToUpdate)
{
