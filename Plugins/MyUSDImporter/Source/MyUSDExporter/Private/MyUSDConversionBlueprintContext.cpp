...
#include "MyUSDConversionBlueprintContext.h"
...
namespace UnrealToUsdImpl = UE::MyUSDExporter::Private;

UMyUsdConversionBlueprintContext::~UMyUsdConversionBlueprintContext()
{
	Cleanup();
}

void UMyUsdConversionBlueprintContext::SetStageRootLayer(FFilePath StageRootLayerPath)
{
	Cleanup();
...
FFilePath UMyUsdConversionBlueprintContext::GetStageRootLayer()
{
	if (Stage)
	{
...
void UMyUsdConversionBlueprintContext::SetEditTarget(FFilePath EditTargetLayerPath)
{
	if (Stage)
	{
...
FFilePath UMyUsdConversionBlueprintContext::GetEditTarget()
{
	if (Stage)
	{
...
void UMyUsdConversionBlueprintContext::Cleanup()
{
	if (Stage)
	{
...
bool UMyUsdConversionBlueprintContext::ConvertDirectionalLightComponent(
...
bool UMyUsdConversionBlueprintContext::ConvertAudioComponent(
...
bool UMyUsdConversionBlueprintContext::ConvertHismComponent(
...
bool UMyUsdConversionBlueprintContext::ConvertInstancedFoliageActor(
...
bool UMyUsdConversionBlueprintContext::ConvertLandscapeProxyActorMesh(
...
bool UMyUsdConversionBlueprintContext::ConvertLandscapeProxyActorMaterial(
...
bool UMyUsdConversionBlueprintContext::ConvertMaterialOverrides(
...
void UMyUsdConversionBlueprintContext::ReplaceUnrealMaterialsWithBaked(
...
bool UMyUsdConversionBlueprintContext::RemoveUnrealSurfaceOutput(const FString& PrimPath, const FFilePath& LayerToAuthorIn)
{
#if USE_USD_SDK
	if (!Stage)
	{
...
int32 UMyUsdConversionBlueprintContext::GetUsdStageNumFrames()
{
#if USE_USD_SDK
	if (!Stage)
	{
