...
public:
	...
	FMyUsdMeshAssetOptions PreviewMeshOptions;
...
namespace UsdUtils
{
	MYUSDEXPORTER_API void AddAnalyticsAttributes(const UAnimSequenceExporterUSDOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes);

	MYUSDEXPORTER_API void HashForAnimSequenceExport(const UAnimSequenceExporterUSDOptions& Options, FSHA1& HashToUpdate);
}
