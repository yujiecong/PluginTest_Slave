...
namespace UsdUtils
{
	MYUSDEXPORTER_API void AddAnalyticsAttributes(const ULevelSequenceExporterUsdOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes);

	MYUSDEXPORTER_API void HashForLevelSequenceExport(const ULevelSequenceExporterUsdOptions& Options, FSHA1& HashToUpdate);
}
