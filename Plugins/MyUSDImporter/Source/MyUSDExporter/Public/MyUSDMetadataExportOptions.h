...
namespace UsdUtils
{
	MYUSDEXPORTER_API void AddAnalyticsAttributes(const FMyUsdMetadataExportOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes);
	MYUSDEXPORTER_API void HashForExport(const FMyUsdMetadataExportOptions& Options, FSHA1& HashToUpdate);
}
