...
struct FMyUsdMetadataExportOptions;
...
public:
	...
	MYUSDEXPORTER_API virtual bool ExportBinary(
		UObject* Object,
		const TCHAR* Type,
		FArchive& Ar,
	 ...
	 */
	MYUSDEXPORTER_API static bool ExportMaterial(
	 ...
	 * @return Whether the export was successful or not.
	 */
	MYUSDEXPORTER_API static bool ExportMaterialsForStage(
