 ...
 * scripting languages.
 *
 * This is an instanceable object instead of just static functions so that the MyUSDStage to use for the
 ...
 */
UCLASS(MinimalAPI, meta = (ScriptName = "UsdConversionContext"))
class UMyUsdConversionBlueprintContext : public UObject
{
	GENERATED_BODY()

	UE_API virtual ~UMyUsdConversionBlueprintContext();
...
public:
	...
	UE_API void SetStageRootLayer(FFilePath StageRootLayerPath);

	/**
	 * Gets the file path of the root layer of our current stage
	 */
	UFUNCTION(BlueprintCallable, Category = "Export context")
	UE_API FFilePath GetStageRootLayer();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Export context")
	UE_API void SetEditTarget(FFilePath EditTargetLayerPath);

	/**
	 * Gets the filepath of the current edit target layer of our internal stage
	 */
	UFUNCTION(BlueprintCallable, Category = "Export context")
	UE_API FFilePath GetEditTarget();
...
public:
	...
	UE_API bool ConvertLightComponent(const ULightComponentBase* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertDirectionalLightComponent(const UDirectionalLightComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertRectLightComponent(const URectLightComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertPointLightComponent(const UPointLightComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertSkyLightComponent(const USkyLightComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);
	...
	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertSceneComponent(const USceneComponent* Component, const FString& PrimPath);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertIsmComponent(const UInstancedStaticMeshComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertHismComponent(const UHierarchicalInstancedStaticMeshComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertMeshComponent(const UMeshComponent* Component, const FString& PrimPath);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertCineCameraComponent(const UCineCameraComponent* Component, const FString& PrimPath, float TimeCode = 3.402823466e+38F);

	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertInstancedFoliageActor(
	...
	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertLandscapeProxyActorMesh(
	...
	UFUNCTION(BlueprintCallable, Category = "Component conversion")
	UE_API bool ConvertLandscapeProxyActorMaterial(
...
public:
	...
	UE_API bool ConvertMaterialOverrides(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Conversion utils")
	UE_API void ReplaceUnrealMaterialsWithBaked(
	...
	UFUNCTION(BlueprintCallable, Category = "Conversion utils")
	UE_API bool RemoveUnrealSurfaceOutput(const FString& PrimPath, const FFilePath& LayerToAuthorIn);

	/** Returns how many frames of animation the stage would generate if imported */
	UFUNCTION(BlueprintCallable, Category = "Conversion utils")
	UE_API int32 GetUsdStageNumFrames();
