...
class UGeometryCacheExporterUSDOptions : public UObject
{
	GENERATED_BODY()
...
namespace UsdUtils
{
	MYUSDEXPORTER_API void AddAnalyticsAttributes(const UGeometryCacheExporterUSDOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes);

	MYUSDEXPORTER_API void HashForGeometryCacheExport(const UGeometryCacheExporterUSDOptions& Options, FSHA1& HashToUpdate);
}
