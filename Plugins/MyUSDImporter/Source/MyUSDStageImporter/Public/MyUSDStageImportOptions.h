...
class UMyUsdStageImportOptions : public UObject
{
...
public:
	...
	UE_API void EnableActorImport(bool bEnable);
...
namespace UsdUtils
{
	...
	{
		FScopedSuppressActorImport(UMyUsdStageImportOptions* InOptions);
	...
	private:
		...
		TWeakObjectPtr<UMyUsdStageImportOptions> Options;
	};

	MYUSDSTAGEIMPORTER_API void AddAnalyticsAttributes(const UMyUsdStageImportOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes);
}
