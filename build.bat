...
echo ========================================
echo  PyManimPlugin Build Script
echo ========================================
echo.

echo [1/2] Cleaning intermediate files...
if exist "%PROJECT_DIR%\Plugins\PyManimPlugin\Intermediate" (
    rmdir /s /q "%PROJECT_DIR%\Plugins\PyManimPlugin\Intermediate"
    echo   Intermediate cleaned.
) else (
    echo   No intermediate to clean.
)
if exist "%PROJECT_DIR%\Plugins\PyManimPlugin\Binaries" (
    rmdir /s /q "%PROJECT_DIR%\Plugins\PyManimPlugin\Binaries"
